...
class AlbumAdmin(admin.ModelAdmin):
    ...
    search_fields = ['title', 'artist__email', 'genre']
...
class TrackAdmin(admin.ModelAdmin):
    ...
    list_filter = ['genre', 'created_at', 'album__artist']
    search_fields = ['title', 'album__title', 'album__artist__email', 'isrc', 'composer']
    readonly_fields = ['duration_seconds', 'created_at', 'updated_at']
    raw_id_fields = ['album']

    def get_artist(self, obj):
        return obj.album.artist.email
    get_artist.short_description = 'Artist'
    get_artist.admin_order_field = 'album__artist__email'
